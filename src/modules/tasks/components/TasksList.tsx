...
import { TaskOptionsPortal } from "@/modules/tasks/components/TaskOptions"

import { useFilterStore } from "@/store/useFilterStore"
import { darkenColor } from "@/utils/darkenColor"
import { cn } from "@/lib/utils"

import * as hooks from "@/modules/tasks/hooks/useTaskHooks"
...
export function TasksTable() {
    ...
    const { data: taskList } = hooks.useTasks(filter)
    const toggleTask = hooks.useCompleteTask()
    const archiveTask = hooks.useArchiveTask()
